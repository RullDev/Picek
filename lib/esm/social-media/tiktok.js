...
import { TiktokDownloaderArgsSchema, TiktokDownloaderSchema, TiktokDownloaderV2Schema, TiktokDownloaderV3Schema, TiktokDownloaderV4Schema } from './types.js';
...
export async function tiktokdlv4(url) {
    var _a;
    TiktokDownloaderArgsSchema.parse(arguments);
    const resToken = await got('https://ssstik.io/id');
    const cookie = (_a = resToken.headers['set-cookie']) === null || _a === void 0 ? void 0 : _a.map(v => v.split(';')[0]).join('; ');
    ...
    return TiktokDownloaderV4Schema.parse(res);
}
