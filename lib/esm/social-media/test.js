...
import { googleIt, tiktokdl, tiktokdlv2, tiktokdlv3, tiktokdlv4, tiktokfyp, tiktokstalk, 
// tiktokfyp,
...
describe('Social media', () => {
    describe('Tiktok scraper', function () {
        ...
        it('tiktokdl v4', function (done) {
            tiktokdlv4('https://www.tiktok.com/@omagadsus/video/7025456384175017243?is_from_webapp=1&sender_device=pc&web_id6982004129280116226').then(function (res) {
                // console.log(res)
                expect(res).to.be.an('object');
                expect(res.author).to.be.an('object');
                expect(res.author.nickname).to.be.a('string');
